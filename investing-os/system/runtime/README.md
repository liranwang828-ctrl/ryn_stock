...
- `inputs/`: day-specific user, agent, and broker inputs, including Stage 0 bootstrap placeholders such as the daily main report, empty research cards/topics JSON files, and a `tracked-metrics.json` placeholder seeded from `investing-os/templates/tracked-metrics-index.json`.
