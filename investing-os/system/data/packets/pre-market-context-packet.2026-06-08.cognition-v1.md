...
status: verified
generated_at: 2026-06-08T13:08:34.821287Z
...
inputs:
  ...
  offline_fixture: ""
  universe: "C:\Users\rriww\Documents\investing-os\system\simulations\inputs\stage0-pre-market-universe.2026-06-08.cognition-v1.json"
data_sources:
  - polygon_cache
missing_data:
...
| :--- | :---: | :--- | :---: | ---: | ---: | :--- |
| NVDA | core | ai_infrastructure | partially_researched | — | — | evidence mapping only |
| COHR | swing | optical | researched_draft | — | — | evidence mapping only |
| ORCL | watchlist | cloud | candidate_only | — | — | evidence mapping only |
| INTC | watchlist | semiconductors | candidate_only | — | — | evidence mapping only |
| RKLB | watchlist | space | candidate_only | — | — | evidence mapping only |
| AVGO | watchlist | semiconductors | candidate_only | — | — | evidence mapping only |
| PLTR | watchlist | ai_infrastructure | candidate_only | — | — | evidence mapping only |
| NET | watchlist | cloud | candidate_only | — | — | evidence mapping only |
...
- [company] [NVDA] NVIDIA, SK Telecom Team Up To Build Korea's AI Powerhouse (Benzinga) (polygon)
- [company] [NVDA] Former IBM Chief Scientist's 3 Filters For SpaceX IPO Buyers (Benzinga) (polygon)
...
- [company] [ORCL] Hybrid Cloud Market Size to Surpass USD 653.45 Billion by 2035 as Data Sovereignty Laws Accelerate Enterprise Adoption Worldwide | SNS Insider (GlobeNewswire Inc.) (polygon)
- [company] [ORCL] 1 Unstoppable Stock to Buy Before It Joins Broadcom in the $1 Trillion Club (The Motley Fool) (polygon)
...
- [company] [RKLB] Could Buying RKLB Before the SpaceX IPO Set You Up for Life? (The Motley Fool) (polygon)
- [company] [RKLB] Why Rocket Lab Stock Plummeted This Week (The Motley Fool) (polygon)
- [company] [AVGO] Why Micron Technology Stock Skyrocketed 87.8% Last Month But Is Falling in June (The Motley Fool) (polygon)
- [company] [AVGO] CrowdStrike Earnings Beat Sparks Selloff—Buy the Dip? (Investing.com) (polygon)
- [company] [PLTR] Last Year, Wall Street Said This AI Stock Was Overvalued. Now, Wall Street Expects It to Deliver Double-Digit Gains. (The Motley Fool) (polygon)
- [company] [PLTR] Consumer Tech News (June 1-3): AI Demand Surge Prompts Big Earnings Beat, AI Can Steal Jobs & More (Benzinga) (polygon)
- [company] [NET] What If the Best Way to Protect Data Was to Delete It First? (Benzinga) (polygon)
- [company] [NET] 9 Software Stocks That Could Thrive as AI Drives Enterprise Spending (Investing.com) (polygon)
