...
def test_compute_structural_nodes_has_required_columns():
    from stock_team.backtest.backtest_micro import compute_structural_nodes
    df = _make_ohlcv(300)
...
def test_simulate_structural_trades_returns_list():
    from stock_team.backtest.backtest_micro import compute_structural_nodes, simulate_structural_trades
    df = _make_ohlcv(300)
...
def test_compute_intraday_signals_has_required():
    from stock_team.backtest.backtest_micro import compute_intraday_signals
    df = _make_5min_df()
...
def test_scan_intraday_params_returns_results():
    from stock_team.backtest.backtest_micro import compute_intraday_signals, scan_intraday_params
...
def test_scan_structural_params_finds_best():
    from stock_team.backtest.backtest_micro import scan_structural_params
    df = _make_ohlcv(400)
