...
def test_compute_daily_signals_has_required_columns():
    ...
    from stock_team.backtest.backtest_engine import _compute_daily_signals
...
def test_forward_return_5d():
    ...
    from stock_team.backtest.backtest_engine import _add_forward_returns
...
def test_scan_signal_returns_scan_result():
    ...
    from stock_team.backtest.backtest_engine import _scan_signal
...
def test_run_signal_scan_structure():
    ...
    from stock_team.backtest.backtest_engine import run_signal_scan
    sym_df = _make_ohlcv(300)
    spy_df = _make_ohlcv(300, start_price=400.0)

    with patch("stock_team.backtest.backtest_engine._fetch_ohlcv") as mock_ohlcv, \
         patch("stock_team.backtest.backtest_engine._fetch_spy") as mock_spy:
...
def test_run_portfolio_scan_aggregates_symbols():
    ...
    from stock_team.backtest.backtest_engine import run_portfolio_scan
    sym_df = _make_ohlcv(300)
    spy_df = _make_ohlcv(300, start_price=400.0)
...
def test_simulate_decision_framework_returns_summary():
    ...
    from stock_team.backtest.backtest_engine import simulate_decision_framework
    sym_df = _make_ohlcv(300)
    spy_df = _make_ohlcv(300, start_price=400.0)
