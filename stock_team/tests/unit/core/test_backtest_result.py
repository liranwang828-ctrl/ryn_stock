...
def test_build_scan_results_computes_improvement():
    ...
    from stock_team.backtest.backtest_result import build_scan_results
...
def test_should_update_thresholds_triggers():
    ...
    from stock_team.backtest.backtest_result import should_update_thresholds
    scan_results = {
        "ma20_dev_max": {
...
def test_consecutive_low_weeks_counts_correctly(tmp_path):
    ...
    from stock_team.backtest.backtest_result import compute_consecutive_low_weeks
...
def test_append_backtest_log_creates_and_appends(tmp_path):
    ...
    from stock_team.backtest.backtest_result import append_backtest_log
...
def test_run_backtest_incremental_schema(tmp_path):
    ...
    from stock_team.backtest.backtest_result import run_backtest
    ...
    with patch("stock_team.backtest.backtest_result.simulate_decision_framework",
...
def test_write_backtest_result_creates_file(tmp_path):
    ...
    from stock_team.backtest.backtest_result import write_backtest_result
    import pathlib
