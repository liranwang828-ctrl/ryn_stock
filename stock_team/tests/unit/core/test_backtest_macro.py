...
def test_compute_macro_signals_has_required_columns():
    from stock_team.backtest.backtest_macro import compute_macro_signals
...
def test_compute_metrics_ev_positive_when_mostly_wins():
    from stock_team.backtest.backtest_macro import compute_metrics
...
def test_apply_macro_filter_reduces_rows():
    from stock_team.backtest.backtest_macro import apply_macro_filter
    df = _make_macro_df()
...
def test_scan_macro_params_returns_results():
    from stock_team.backtest.backtest_macro import scan_macro_params
    df = _make_macro_df()
    param_grid = {
