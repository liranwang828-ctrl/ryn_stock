...
def test_macro_has_vix(tmp_path):
    ...
    import glob, pytest
    base = next(p for p in [os.path.abspath(__file__)] + [os.path.dirname(os.path.abspath(__file__))] + [os.path.dirname(os.path.dirname(os.path.abspath(__file__)))] + [os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))] + [os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))] if os.path.exists(os.path.join(p, "templates")))
...
def test_order_sheet_has_flex_reduce():
    ...
    with patch("stock_team.core.premarket_order_sheet._get_technicals", return_value=mock_tech), \
         patch("stock_team.core.premarket_order_sheet._load_json", return_value={}):
...
def test_premarket_summary_cli(tmp_path, monkeypatch):
    ...
    import stock_team.core.premarket_summary as m
