...
def test_rebuild_knowledge_index_counts_all_time_and_latest_questions(tmp_path):
    from stock_team.utils.knowledge_index import rebuild_knowledge_index
...
def test_append_knowledge_event_updates_index_and_dashboard_reads_all_time(tmp_path):
    ...
    from stock_team.utils.knowledge_index import load_knowledge_index
    from stock_team.utils.knowledge_schema import normalize_lesson
    from stock_team.utils.knowledge_store import append_knowledge_event
