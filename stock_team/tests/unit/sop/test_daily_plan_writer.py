...
def test_action_now_exit_beats_entry():
    ...
    from stock_team.core.daily_plan_writer import compute_action_now
...
def test_compute_gtc_status_missing(tmp_path):
    ...
    from stock_team.core.daily_plan_writer import compute_gtc_status
...
def test_next_action_red_alert_is_immediate():
    ...
    from stock_team.core.daily_plan_writer import compute_next_action
    session_state = {
...
def test_build_daily_plan_schema(tmp_path):
    ...
    from stock_team.core.daily_plan_writer import build_daily_plan
    date = "2026-05-20"
