...
def test_build_position_context(tmp_path):
    ...
    from stock_team.core.strategic_memo_writer import build_position_context
...
def test_load_agent_analysis(tmp_path):
    ...
    from stock_team.core.strategic_memo_writer import load_agent_analysis_per_sym
    date = "2026-05-20"
...
def test_load_debate_highlights(tmp_path):
    ...
    from stock_team.core.strategic_memo_writer import load_debate_highlights
    date = "2026-05-20"
...
def test_build_scenarios(tmp_path):
    ...
    from stock_team.core.strategic_memo_writer import build_scenarios
    _make_positions(tmp_path, "NVDA")
