...
def test_build_execution_entry_triggered(tmp_path):
    ...
    from stock_team.data_ingest.postmarket_data_collector import build_execution
    date = "2026-05-20"
...
def test_signal_accuracy_consensus_correct(tmp_path):
    ...
    from stock_team.data_ingest.postmarket_data_collector import build_signal_accuracy
    date = "2026-05-20"
...
def test_build_per_stock_summary_schema(tmp_path):
    ...
    from stock_team.data_ingest.postmarket_summary import build_per_stock_summary
    date = "2026-05-20"
    _make_premarket(tmp_path, "TEST", date)
    _make_intraday(tmp_path, "TEST", date)
...
def test_write_per_stock_summary_creates_file(tmp_path):
    ...
    from stock_team.data_ingest.postmarket_summary import build_per_stock_summary, write_per_stock_summary
    date = "2026-05-20"
    _make_premarket(tmp_path, "TEST", date)
    _make_intraday(tmp_path, "TEST", date)
...
def test_apply_suggestion_thesis_status(tmp_path):
    ...
    from stock_team.core.suggestion_applier import apply_suggestion
