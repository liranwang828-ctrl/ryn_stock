...
from stock_team.utils.protocol import BASE, VERIFIED_PATH, FINDINGS_DIR, EXIT_OK, EXIT_FAIL
...
def main():
    ...
    if args.field:
        ...
        json.dump(out, open(os.path.join(FINDINGS_DIR, f"verifier_r{args.round}_{args.field}.json"), "w", encoding="utf-8"), indent=2)
    else:
        ...
        json.dump(out, open(VERIFIED_PATH, "w", encoding="utf-8"), indent=2)
