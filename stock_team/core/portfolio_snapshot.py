...
输出:
- findings/portfolio_snapshot_current.json（dashboard 当前态）
- findings/portfolio_snapshot_{date}.json（每日历史归档）
...
from stock_team.core.portfolio_risk_agent import compute_portfolio_risk
