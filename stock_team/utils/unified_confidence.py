...
用法:
  from stock_team.utils.unified_confidence import compute
  result = compute("NVDA")
"""
import os, json
...
def compute(sym: str, track: str = "swing", strategy_data: dict = None) -> dict:
    ...
    try:
        ...
        if strategy_data and strategy_data.get("symbol") == sym:
            ...
            from stock_team.utils.protocol import STRATEGY_PATH
    ...
    try:
        from stock_team.utils.market_calendar import get_time_factor
